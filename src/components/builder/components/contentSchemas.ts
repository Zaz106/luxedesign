...
export const variantContentSchemas: Record<string, ContentField[]> = {
  ...
  "cta-bold": [
    { key: "heading",     label: "Heading",           type: "text",     defaultValue: "ARE YOU READY TO\nTHRIVE?" },
    { key: "placeholder", label: "Input Placeholder",  type: "text",     defaultValue: "Drop Us Your Email" },
    { key: "btnText",     label: "Button Text",        type: "text",     defaultValue: "Submit" },
    { key: "subtext",     label: "Subtext",            type: "text",     defaultValue: "We'll reach out as soon as possible." },
  ],
  "cta-split": [
    { key: "eyebrow",      label: "Eyebrow Label",      type: "text",     defaultValue: "Why Choose Us?" },
    { key: "heading",      label: "Heading",            type: "text",     defaultValue: "Designed for Modern Living" },
    { key: "feature1Title",label: "Feature 1 Title",    type: "text",     defaultValue: "Convenience" },
    { key: "feature1Desc", label: "Feature 1 Description", type: "textarea", defaultValue: "Access our services on your terms, with minimal disruptions to your day." },
    { key: "feature2Title",label: "Feature 2 Title",    type: "text",     defaultValue: "Personalization" },
    { key: "feature2Desc", label: "Feature 2 Description", type: "textarea", defaultValue: "We focus on you, not just your challenges." },
  ...
  "cta-gradient": [
    { key: "heading", label: "Heading",      type: "textarea", defaultValue: "Bring clarity, structure, and speed to your workflow" },
    { key: "btnText", label: "Button Text",  type: "text",     defaultValue: "Start your Workspace" },
  ],
  "cta-dark-banner": [
    { key: "heading",     label: "Heading",            type: "textarea", defaultValue: "Enhance customer experience and maximize revenue with your payments." },
    { key: "subheading",  label: "Subheading",         type: "textarea", defaultValue: "Use our flexible building blocks to build secure and compliant workflows." },
    { key: "primaryBtn",  label: "Primary Button",     type: "text",     defaultValue: "Book a demo →" },
    { key: "secondaryBtn",label: "Secondary Button",   type: "text",     defaultValue: "Try for free" },
  ],
  "footer-classic": [
    { key: "logo", label: "Logo Text", type: "text", defaultValue: "Brand" },
    { key: "tagline", label: "Tagline", type: "textarea", defaultValue: "Building scalable digital solutions for modern businesses, crafted with precision." },
    { key: "col1Title", label: "Column 1 Title", type: "text", defaultValue: "Explore" },
    { key: "col1Links", label: "Column 1 Links", type: "list", defaultValue: "Home, About Us, What We Do, Pricing, Contact Us" },
    { key: "col2Title", label: "Column 2 Title", type: "text", defaultValue: "About" },
    { key: "col2Links", label: "Column 2 Links", type: "list", defaultValue: "Services, Our Work, Pricing, Our Team" },
    { key: "col3Title", label: "Column 3 Title", type: "text", defaultValue: "Support" },
    { key: "col3Links", label: "Column 3 Links", type: "list", defaultValue: "Contact Us, Community, Support" },
    { key: "copyright", label: "Copyright", type: "text", defaultValue: "Produced by @Brand" },
  ],
  "footer-minimal": [
    { key: "logoText", label: "Logo Text", type: "text", defaultValue: "Brand" },
    { key: "tagline", label: "Tagline", type: "text", defaultValue: "Have any questions or feedback? Reach out below" },
    { key: "email", label: "Email", type: "text", defaultValue: "hello@example.com" },
    { key: "phone", label: "Phone", type: "text", defaultValue: "+1 234 567 890" },
    { key: "navLinks", label: "Nav Links", type: "list", defaultValue: "Home, About Us, What We Do, Pricing, Contact Us" },
    { key: "resourceLinks", label: "Resource Links", type: "list", defaultValue: "Wellness Tips, What We Offer, Weight Loss Challenge, About Us" },
    { key: "supportLinks", label: "Support Links", type: "list", defaultValue: "FAQs, Contact us, Testimonials, Pricing" },
    { key: "copyright", label: "Copyright", type: "text", defaultValue: "Copyright 2026. All Rights Reserved" },
  ],
  "footer-spinny": [
    { key: "navItems", label: "Nav Items", type: "list", defaultValue: "HOME, ABOUT US, PROJECTS, NEWS/BLOG, SHOP, FAQ, CONTACT US" },
    { key: "copyright", label: "Copyright", type: "text", defaultValue: "Copyright \u00a9 2026. All Rights Reserved." },
    { key: "legalText", label: "Legal Link Text", type: "text", defaultValue: "THE LEGAL STUFF" },
  ],
  "footer-bigname": [
    { key: "logo", label: "Brand Name", type: "text", defaultValue: "Brand" },
    { key: "tagline", label: "Tagline", type: "text", defaultValue: "Building the future of the web, one pixel at a time." },
    ...
    { key: "col2Links", label: "Column 2 Links", type: "list", defaultValue: "Blog, Careers, Press, Contact Us" },
    { key: "socialLinks", label: "Social Links", type: "list", defaultValue: "Instagram, X, Facebook, LinkedIn, TikTok" },
    { key: "copyright", label: "Copyright", type: "text", defaultValue: "\u00a9 2026 Brand. All rights reserved." },
  ],
  "footer-immersive": [
    { key: "logo", label: "Logo Text", type: "text", defaultValue: "Brand" },
    { key: "tagline", label: "Top Tagline", type: "text", defaultValue: "Work fast. Live slow." },
    ...
    { key: "col3Links", label: "Column 3 Links", type: "list", defaultValue: "Blog, Newsletter, Case Studies" },
  ],
  "footer-corporate": [
    { key: "logo", label: "Logo / Brand Name", type: "text", defaultValue: "Brand" },
    { key: "tagline", label: "Tagline", type: "textarea", defaultValue: "Building scalable digital experiences for modern businesses \u2014 designed with purpose, built with precision." },
    { key: "col1Title", label: "Column 1 Title", type: "text", defaultValue: "Pages" },
    { key: "col1Links", label: "Column 1 Links", type: "list", defaultValue: "Home, About Us, What We Do, Pricing, Contact Us" },
    { key: "col2Title", label: "Column 2 Title", type: "text", defaultValue: "Resources" },
    { key: "col2Links", label: "Column 2 Links", type: "list", defaultValue: "Blog, Case Studies, Newsletter, Documentation" },
    { key: "col3Title", label: "Column 3 Title", type: "text", defaultValue: "Company" },
    { key: "col3Links", label: "Column 3 Links", type: "list", defaultValue: "About Us, Careers, Press, Partners" },
    { key: "copyright", label: "Copyright", type: "text", defaultValue: "\u00a9 2026 Brand. All rights reserved" },
