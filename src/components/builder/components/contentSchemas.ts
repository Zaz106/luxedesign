...
export const variantContentSchemas: Record<string, ContentField[]> = {
  ...
  "footer-minimal": [
    { key: "logoText", label: "Logo Text", type: "text", defaultValue: "LOGO" },
    ...
    { key: "navLinks", label: "Nav Links", type: "list", defaultValue: "Home, About Us, What We Do, Workshops, Pricing" },
  ...
  "footer-bigname": [
    ...
    { key: "tagline", label: "Tagline", type: "text", defaultValue: "Run conversational product demos, 24/7" },
    { key: "col1Title", label: "Column 1 Title", type: "text", defaultValue: "Platform" },
    { key: "col1Links", label: "Column 1 Links", type: "list", defaultValue: "Features, Outcomes, How it works, Use Cases" },
    { key: "col2Title", label: "Column 2 Title", type: "text", defaultValue: "Company" },
    { key: "col2Links", label: "Column 2 Links", type: "list", defaultValue: "Terms, Privacy Policy, Trust Center" },
    { key: "socialLinks", label: "Social Links", type: "list", defaultValue: "X, in" },
